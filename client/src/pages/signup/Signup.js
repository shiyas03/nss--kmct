  ...
  return (
    <div className="register-main">
      <div className="register-left">
        <img alt="Full" src="/assets/teacher&student.jpg" />
      </div>
      <div className="register-right">
        <div className="register-right-container">
          <div className="register-logo">
            <img alt="logo" src="/assets/nsslogo.png" />
          </div>
              ...
              <div className="fourth-slide" style={{ display: "none" }}>
                <div className="pass-input-div">
                  ...
                  {showPassword ? (
                    ...
                    >
                      <img className="hide" src="/assets/hide.png" alt="hide" />
                    </button>
                  ) : (
                    <button
                      type="button"
                      ...
                      style={{ color: "white", padding: 0 }}
                    >
                      <img className="see" src="/assets/see.png" alt="see" />
                    </button>
                  )}
                </div>
                <div className="pass-input-div">
