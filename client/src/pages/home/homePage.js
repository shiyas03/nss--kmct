...
const HomePage = () => {
  return (
    <main>
      ...
      <section class="relative">
        <div class="mx-auto w-full max-w-7xl px-5 py-16 md:px-10">
          <div class="grid grid-cols-1 items-center gap-8 sm:gap-20 lg:grid-cols-2">
            <div class="">
              <h1 class="mb-3 pb-4 text-4xl font-extrabold md:text-6xl">Welcome to NSS UNIT 325 – KMCT</h1>
              <h1 class="mb-3 pb-4 text-4xl font-bold text-blue-700 md:text-4xl">"Not Me, But You"</h1>
              <p class="mb-6 max-w-[528px] text-xl md:mb-10">Join us in shaping a better society while developing leadership & teamwork!</p>
              <div class="flex items-center">
                <a href="/login"
                  class="mr-5 text-white inline-block rounded-full bg-blue-600 px-6 py-3 text-center font-bold hover:bg-blue-500 md:mr-6 lg:mr-8">
                  Join NSS Today!
                </a>
              </div>
            </div>
            <div>
              <img src="https://www.kmctartskuttippuram.org/images/student-subcat/imageimageb13fe39cb1dd9ba9678a02c0b1c43fe6fbf8f667.jpg" alt="" class="mx-auto inline-block h-full w-full rounded-2xl object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        <div id="about" class="relative bg-white flex pb-20">
          <div class="md:w-1/2 w-full flex justify-center">
            <div class="ps-28 relative z-10 bg-white">
              <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div class="sm:text-center lg:text-left">
                  <h2 class="my-6 text-2xl tracking-tight font-bold text-gray-900 sm:text-3xl md:text-5xl">
                    About Us
                  </h2>
          ...
          <div class="md:w-1/2 flex flex-col space-y-5 justify-end px-10">
